...
class UsuarioController extends Prato_Controller_Action {
    ...
    public function createAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($values)) {
                ...
                $flashMessenger->addMessage('Administrador salvo com sucesso');
    ...
    public function deleteAction() {
        ...
        try {
            ...
            $flashMessenger->addMessage('Administrador excluido com sucesso');
    ...
    public function updateAction() {
        ...
        if (!$adminRow) {
            $flashMessenger->addMessage('Administrador nao existe');
            $this->_helper->redirector->gotoSimpleAndExit('index');
        }
